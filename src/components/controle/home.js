          ...
          <View style={styles.infoBoxModal}>
            ...
            <View style={styles.infoBoxContent}>
              <View style={{flexDirection: 'column'}}>
                <Text style={{textAlign: 'center', color: '#B6B6B6'}}>
                  {dataModal}
                </Text>
                <Text
                  style={{
              ...
              <View style={{flexDirection: 'row'}}>
                <Text style={{flex: 1, color: '#00D1FF', fontWeight: 'bold'}}>
                  Pedidos
                </Text>
              ...
              <View style={{flexDirection: 'row'}}>
                <Text style={{flex: 1, color: '#FF5757', fontWeight: 'bold'}}>
                  Taxa(5%)
                </Text>
    ...
    const lData = uniData.map((item, index) => {
      ...
      return (
        <View key={index}>
          <DataTable.Row>
            <DataTable.Cell>
              <Text style={{color: '#7EE8FF'}}>{item}</Text>
            </DataTable.Cell>
            <DataTable.Cell>
              <Text style={{color: '#7EE8FF'}}>{ContaPedidos()[item]}</Text>
            </DataTable.Cell>
            <DataTable.Cell
