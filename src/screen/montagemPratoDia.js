...
import { Text, Container, Content, Icon, CardItem, Item, Picker } from 'native-base';
...
const montagemPratoDia = ({ navigation }) => {
  ...
  useEffect(() => {
    const subscriber = DB.collection('Acompanhamentos')
  ...
  function gravaCardapio() {
    ...
    Alert.alert(
      'Sucesso!',
      "Cardápio cadastrado e disponibilizado!",
      [
        {
          text: 'Ok',
          onPress: () => {
